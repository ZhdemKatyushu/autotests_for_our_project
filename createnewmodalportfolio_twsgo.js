...
module.exports = {
    tags: ['c_m_p_twsgo'],
    'Create new modal portfolio twsgo dev': function (browser) {
        ...
        page
            ...
            .click('@modalItemInTypeCreatePortfolioDropDown')
            .click('@addImagesForModalPortfolioButton')
            .setValue('@addImageForModalPortfolioField', 'https://3diphonewallpaper.com/wp-content/uploads/2019/02/iPhone-X-Wallpaper-Cute-Girl-Pic.jpg')
            ...
            .pause(2000)
            .saveScreenshot('tests_output/created_modal_portfolio_twsgo.png')
            .end();
    }
};
